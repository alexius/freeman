...
var lg = [];
$.ajax({
  url: '/admin/jasfinder/scripts/languages/'  + culture + '.js',
  async: false,
  dataType: 'json',
...
var getFileInfo = function(file){
	...
	if(data['Code'] == 0){
		...
		$('#fileinfo').find('img').attr('src',data['Url']);
...
var getFolderInfo = function(path){
	...
	$('#fileinfo').html('<img id="activity" src="/admin/jasfinder/images/wait30trans.gif" width="30" height="30" />');
